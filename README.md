...
* Gephi changed SVG path element format (d parameter) from release 1.0 and Graph-Presenter has not been updated to read this format yet. **Use Gephi version prior to release 0.1.0**
